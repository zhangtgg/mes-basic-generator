...
import cn.tfinfo.microservice.mes.basic.generator.common.utils.JsonUtils;
...
public class GeneratorConfig {
    ...
    public GeneratorInfo getGeneratorConfig() {
        ...
        // 模板配置文件
        InputStream isConfig = this.getClass().getResourceAsStream(template + Config.getInstance().getTemplateFile());
        if (isConfig == null) {
